...
class BarChart extends Component {
  ...
  createBarChart() {
    const node = this.node; // the element itself is referenced in the component when you render so you can use it to hand over to D3
    ...
    select(node)
      ...
      .attr('width', barWidth)
      .style('fill', (d, i) => this.props.colourScale(d.launchDay))
      .style('stroke', 'black')
